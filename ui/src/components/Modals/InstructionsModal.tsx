...
const steps = [
  {
    ...
    description: `Select between time/trend line, where you can add multiple countries and multiple indicators in the same chart,
    and correlation plot to see how two different indicators affect each other in a scatter plot.`,
    icon: inst_1,
  },
  {
...
> = (props) => {
  ...
  return (
    <Modal className="d-flex" show={showModal} onHide={handleClose} centered>
...
export default React.memo(InstructionsModal);
